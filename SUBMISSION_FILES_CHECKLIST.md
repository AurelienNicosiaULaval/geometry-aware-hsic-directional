...
| Citation metadata | `CITATION.cff` | Present, uses Zenodo concept DOI |
...
| Zenodo version DOI | To be recorded after the clean submission release is archived | Not cited in manuscript |
| GitHub release | Clean submission release | To be confirmed |
