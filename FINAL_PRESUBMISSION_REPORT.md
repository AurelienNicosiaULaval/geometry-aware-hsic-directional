...
`bd727dcff8f023c672bca59293aee375121ac940`
...
- the stable Zenodo concept DOI
- the stable Zenodo concept DOI for the archived replication materials
...
mathematical change was made. The compiled PDF page containing Lemma 1 was
also inspected visually; the conjugation bar appears correctly over `c_j`.
...
- current clean submission snapshot: `v1.0.1-csda-submission`
- Zenodo concept record: `https://zenodo.org/records/20617102`

The concept DOI is included in the README, `CITATION.cff` and manuscript Code
and data availability section.

## Reproducibility checks

The README contains commands for:
...
- Confirm that the clean submission release is the intended submission release.
